...
def load_file(right_panel, db):
    ...
    try:
        ...
        ttk.Button(top_bar, text="Export to Excel", style="Bold.TButton",
                   command=lambda: export_tree_to_excel()).pack(side="right", padx=5, pady=(10, 0))
...
def tester_panel(tester_data, db):
    ...
    ttk.Button(left_panel, text="Export to Excel", style="Bold.TButton", command=export_tree_to_excel).pack(pady=(3, 3), padx=8, fill="x")
