...
def enter_test_end_date(db, excel_file_path):
    ...
    ttk.Label(date_win, text="Select Test End Date:", style="Custom.TLabel").pack(pady=(10, 5))
...
def enter_test_start_date(db, excel_file_path):
    ...
    ttk.Label(date_win, text="Select Test Start Date:", style="Custom.TLabel").pack(pady=(10, 5))
    cal = DateEntry(date_win, date_pattern="dd-mm-yyyy")
    cal.pack(pady=5)
